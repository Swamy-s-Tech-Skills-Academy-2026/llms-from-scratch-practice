...
Example I noticed from DeepSeek-V3: It has 671 Billion total parameters, yet during inference, only 37 Billion are active at any one time because the router only picks 8 out of 256 experts!
